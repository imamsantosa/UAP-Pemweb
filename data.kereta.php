        ...
        <div class="container-fluid">
          ...
          <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="nav navbar-nav">
              ...
              <li class="active"><a href="data.kereta.php">Data Kereta <span class="sr-only">(current)</span></a></li>
                  ...
                  <?php
                    ...
                    foreach ($list_kereta as $kereta) {
                      ...
                      <tr>
                        ...
                        <td><a href="data.penumpang.php?id=<?php echo $kereta['id_kereta'];?>" >Lihat Data</a></td>
                      </tr>
                      <?php
                    }
